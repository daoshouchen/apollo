 ...
 * 实现税友自己的注册中心配置逻辑
 *
 * 从application.properties文件中
 *
 * 读取config.center.address
 */
public class ServyouMetaServerProvider implements MetaServerProvider {
    ...
    public ServyouMetaServerProvider() {
        initialize();
    }

    private void initialize() {
        Properties prop = new Properties();
        prop = ResourceUtils.readConfigFile("config-center-servers.properties", prop);
